...
function RolesContent({ onUpgrade }) {
  ...
  const ALL_DEFAULT_ROLES = [
    { name: 'Owner',          slug: 'owner',           is_system: true,  permissions: ['orders.view','orders.create','orders.edit','orders.cancel','products.view','products.create','products.edit','products.delete','categories.view','categories.create','categories.edit','categories.delete','inventory.view','inventory.edit','inventory.adjust','inventory.restock','inventory.stock_take','inventory.delivery_order','tables.view','tables.create','tables.edit','tables.delete','staff.view','staff.create','staff.edit','staff.delete','roles.view','roles.create','roles.edit','roles.delete','reports.view','reports.export','settings.view','settings.edit','theme.edit','suppliers.view','suppliers.create','suppliers.edit','suppliers.delete','payments.view','payments.edit'] },
    { name: 'Manager',        slug: 'manager',         is_system: false, permissions: ['staff.view','staff.edit','products.view','products.create','products.edit','categories.view','categories.create','categories.edit','inventory.view','inventory.adjust','inventory.restock','inventory.stock_take','inventory.delivery_order','orders.view','orders.create','orders.edit','tables.view','tables.edit','payments.view','reports.view','suppliers.view','suppliers.edit'] },
    ...
    ...(isFnB
      ...
      : [{ name: 'Inventory Staff', slug: 'inventory_staff', is_system: false, permissions: ['products.view','inventory.view','inventory.edit','inventory.adjust','inventory.restock','inventory.stock_take','inventory.delivery_order','categories.view','suppliers.view','suppliers.edit'] }]
    ),
  ];
