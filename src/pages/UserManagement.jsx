...
function RolesContent({ onUpgrade }) {
  ...
  const ALL_DEFAULT_ROLES = [
    ...
    ...(isFnB
      ...
      : [{ name: 'Inventory Staff', slug: 'inventory_staff', is_system: false, permissions: ['products.view','inventory.view','inventory.edit','inventory.adjust','inventory.restock','inventory.delivery_order','categories.view','suppliers.view','suppliers.edit'] }]
    ),
  ];
