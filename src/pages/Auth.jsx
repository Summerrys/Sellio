          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="text-center mb-6">
              ...
              <div className="relative inline-block">
                <p className="text-4xl font-bold text-slate-900 tracking-tight">Your business,</p>
                <p className="text-4xl font-bold text-slate-900 tracking-tight mt-1">beautifully <span className="bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 bg-clip-text text-transparent">online</span>.</p>
